...
public final class process_005frigister_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try
{
           ...
           int i =st.executeUpdate("insert into regi(Firstname,lastname,gender,phoneno,email,password)values('"+Firstname+"','"+lastname+"','"+gender+"','"+phoneno+"','"+email+"','"+password+"')");
