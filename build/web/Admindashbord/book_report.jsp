<%-- 
    ...
    Created on : 29 Mar, 2024, 8:37:41 PM
    Author     : HP
--%>
...
border-radius: 30px;
    ...
    <body>
    <div class="label">
        <h1 class="title">Booking Report</h1></div>
        <p align="center"><div id="export" align="center">
            <div class="container">
        <table width="1028" border="1" align="center" bordercolor="#e60073">
            <tr><th width="70" class="style4">Booking Id</th>
                <th width="219" class="style4">First Name</th>
                <th width="233" class="style4">Last name</th>
                 <th width="134" class="style4">Email Id</th>
                <th width="138" class="style4">Phone No</th>
                <th width="134" class="style4">Addhar no</th>
                <th width="70" class="style4">check In Date</th>
                <th width="118" class="style4">Check Out Date</th>
                    <th width="118" class="style4">Room Type</th>
            </tr>
            </div>
            <%
            while(rs.next())
            ...
            <tr>
                ...
                <td><div align="center" class="style4"><%=rs.getString(5)%> </div></td>
                <td><div align="center" class="style4"><%=rs.getString(6)%> </div></td>
                <td><div align="center" class="style4"><%=rs.getString(7)%> </div></td>
                 <td><div align="center" class="style4"><%=rs.getString(8)%> </div></td>
                  <td><div align="center" class="style4"><%=rs.getString(9)%> </div></td>
            </tr>
            <%
            }
%>          
