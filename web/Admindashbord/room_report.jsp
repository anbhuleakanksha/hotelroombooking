<%-- 
    Document   : room_report
    Created on : 12 Mar, 2024, 9:52:58 AM
    Author     : HP
--%>
...
border-radius: 30px;
    ...
    <body>
    <div class="label">
        <h1 class="title">Room Booking Report</h1></div>
        <p align="center"><div id="export" align="center">
            <div class="container">
        <table width="1028" border="1" align="center" bordercolor="#e60073">
            <tr><th width="70" class="style4">Room id</th>
                <th width="219" class="style4">Room Type</th>
                <th width="233" class="style4">Room Price</th>
                <th width="70" class="style4">Room Description</th>
