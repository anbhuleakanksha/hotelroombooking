...
<%-- 
    ...
    Created on : 11 Mar, 2024, 11:24:07 AM
    Author     : HP
--%>
...
border-radius: 30px;
    ...
    <body>
    <div class="label">
        <h1 class="title">Payment Report</h1></div>
        ...
        <table width="1028" border="1" align="center" bordercolor="#e60073">
            <tr><th width="70" class="style4">User Id</th>
                ...
                <th width="70" class="style4">Phone No</th>
                <th width="138" class="style4">room type</th>
                <th width="134" class="style4">Quantity</th>
                <th width="118" class="style4">price</th>
                 <th width="118" class="style4">Pay Type</th>
            </tr>
            </div>
            <%
            while(rs.next())
